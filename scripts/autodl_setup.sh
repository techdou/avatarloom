...
echo "     本地终端执行：ssh -L 13000:127.0.0.1:3000 -L 18100:127.0.0.1:8100 -L 18101:127.0.0.1:8101 root@<AutoDL IP>"
echo "     然后浏览器开 http://localhost:13000"
echo ""
echo "     ⚠ 不要直接暴露 3000/8100/8101 到公网——Studio 绑 127.0.0.1，"
