...
echo ""
echo "  4. 通过 SSH 隧道访问（推荐，安全）："
echo "     本地终端执行：ssh -L 27300:127.0.0.1:27300 -L 27810:127.0.0.1:27810 -L 27811:127.0.0.1:27811 root@<AutoDL IP>"
echo "     然后浏览器开 http://localhost:27300"
echo ""
echo "     ⚠ 不要直接暴露 27300/27810/27811 到公网——Studio 绑 127.0.0.1，"
echo "       且未设 AVATARLOOM_API_TOKEN 时 control-api 全端点无鉴权。"
echo ""
